...
$header .= "From: Новая заявка <sash-obrazco@yandex.ru>\n\n";	
$mail = mail("sash-obrazco@yandex.ru", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
